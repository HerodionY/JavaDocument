...
public class Mahasiswa {
    ...
    public Mahasiswa(String nama, String nim, String tglLahir, String nilaiHuruf, int uts1, int uts2, int uas, double nilaiFinal,String jenjang,String status ) {
        this.nama = nama;
        this.nim = nim;
...
public String status(String nilaiHuruf){
        String nilai= nilaiHuruf;
        String Status;
